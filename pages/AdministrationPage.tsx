  ...
  return (
    <div className="p-6 bg-white dark:bg-secondary-800 rounded-lg shadow">
      ...
      <p className="text-secondary-600 dark:text-secondary-300">
        System administration tasks such as user management, role configuration, audit logs, and system settings will be managed here.
      </p>
      <div className="mt-8 h-96 bg-secondary-200 dark:bg-secondary-700 rounded-md flex items-center justify-center">
        <p className="text-secondary-500 dark:text-secondary-400">Admin Panel Placeholder</p>
      </div>
    </div>
  );
};
