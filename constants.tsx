...
export const MOCK_TASK_DATA = [
  { name: 'Completed', value: 60, color: '#22c55e' }, // green-500
  { name: 'Pending', value: 25, color: '#f59e0b' },   // amber-500
  { name: 'Not Started', value: 15, color: '#ef4444' },// red-500
];
...
export const MOCK_STICKY_NOTES = [
  { id: 'note1', text: 'Follow up with Dr. Smith re: patient X.', color: 'bg-yellow-200 dark:bg-yellow-700' },
  { id: 'note2', text: 'Prepare report for weekly meeting.', color: 'bg-blue-200 dark:bg-blue-700' },
  { id: 'note3', text: 'Review new patient intake forms.', color: 'bg-green-200 dark:bg-green-700' },
];